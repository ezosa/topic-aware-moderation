...
def train(model,
    ...
    for epoch in range(num_epochs):
        ...
        for train_batch in train_loader:
            ...
            pred = model(text, text_len, topic_embedding.float())
...
parser = argparse.ArgumentParser(description='Training Late Fusion 2: text + topic embeddings')
...
model_name = "lateFusion2_text_" + str(args.num_topics) + "topicVectors_" + str(args.topic_dim) + "topicDim_" + \
