...
parser = argparse.ArgumentParser(description='Testing LF1')
parser.add_argument('--model_name', type=str, default='LF1', help='name of trained model')
...
log_file = open(save_path + model_name + "_test_logs.txt", 'w')
