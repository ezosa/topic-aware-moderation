...
parser = argparse.ArgumentParser(description='Testing EF3')
parser.add_argument('--model_name', type=str, default='EF3_', help='name of trained model')
...
for test_file in test_files:
    ...
    best_model = LSTMEncoder2(lstm_args=lstm_args,
