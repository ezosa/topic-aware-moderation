...
def evaluate(model, test_loader, threshold=0.5):
    ...
    with torch.no_grad():
        for test_batch in test_loader:
            ...
            y_score_i = model(text, text_len, topic_embedding.float())
...
parser = argparse.ArgumentParser(description='Testing EF2')
parser.add_argument('--model_name', type=str, default='EF2_', help='name of trained model')
